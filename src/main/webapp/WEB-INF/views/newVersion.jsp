...
<link rel="stylesheet"
	href='<c:url value="/resources/css/dropdownsytle.css" />'>
...
<%-- 		<table>
			<tr style="position: absolute; left: 120px; top: 150px">
				<td><form:form class="feedback-input"
						action="/addReportAndVersion/${testcase.id}" method="POST"
	    ...
	    <form:form action="addVersion" method="post" modelAttribute="version" style="position: absolute; left: 400px; top: 150px"> 
	         
			  <form:input path="name" name="name" type="text" class="feedback-input" placeholder="Report name" />   
			  <form:input path="datelaunched" name="datelaunched" type="date" class="feedback-input" placeholder="YYYY-MM-DD" />
