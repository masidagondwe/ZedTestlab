	...
	<div class="section" id="home">
			...
			<div class="container-fluid">
				...
				<nav id="navigation"
					...
					<ul id="header-nav" class="nav navbar-nav">
						...
						<li>&nbsp;&nbsp;&nbsp;</li>
						<li class="header-login-button"><a href="<c:url value='/' />"
							class="btn nav-button">LOGOUT</a></li>
					</ul>
				</nav>
			</div>
		</header>
		...
		<form:form action="save" method="post" modelAttribute="project">
			<form:input path="id" name="id" type="text"
				class="feedback-input" placeholder="${project.id}" />
			<form:input path="name" name="name" type="text"
				class="feedback-input" placeholder="${project.name}" />
			<form:input path="datelaunched" name="datelaunched" type="text"
				class="feedback-input" placeholder="${project.datelaunched}" />
