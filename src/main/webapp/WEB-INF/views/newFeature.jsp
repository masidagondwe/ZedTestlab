...
<body>
	...
	<div class="section" id="home">
		...
		<!-- fill in form  -->
		<form:form action="addFeature" method="post" modelAttribute="feature">

			<form:input path="name" name="name" type="text" class="feedback-input"
				placeholder="Feature name" /> 
			<form:input path="function" name="function" type="text"
				class="feedback-input" placeholder="Function" /> 
			<form:input path="type"  name="type"
				type="text" class="feedback-input" placeholder="Feature type" /> 
		 	<!-- -----CHOOSE PROJECT FROM DROP DOWN LIST----- -->
			<form:select path="project.id" class="feedback-input" style="background-color: #008080;">
